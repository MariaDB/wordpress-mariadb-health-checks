...
<?php if ( $dbInformation['isEndOfLive'] ) { ?>
	<div class="notice notice-error">
		...
		<p>Find a newer version here <a href="<?php echo $mariaDBUrlDownload; ?>" target="_blank"><?php echo $mariaDBUrlDownload; ?>.</a></p>
	</div>
<?php } else { ?>
		...
		if ( isset( $mdbhc_gd['version'] ) ) {
			...
			<tr>
				<td><?php
					...
					?></td>
				<td><?php echo $mdbhc_gd['version'];
					if ( isset( $mdbhc_gd['version_comment'] ) ) {
						echo $mdbhc_gd['version_comment'];
					} ?></td>
			</tr>
			<?php
		}
